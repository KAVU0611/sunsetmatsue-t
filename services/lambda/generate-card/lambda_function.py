...
def _generate_image_from_bedrock(card: CardRequest) -> bytes:
    yomegashima_prompt = (
        "The composition must clearly feature the small Yomegashima island "
        "sandbar in Lake Shinji, with its torii or silhouette visible near the horizon."
    )
    base_prompt = (
